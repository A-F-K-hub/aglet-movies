...
import { setCurrentUserAction, setIsLoadingGetCurrentUserAction } from "../reducers/users-reducer/users.reducer";
import "./Login.css";
...
function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      userApiService.getCurrentUser(loginResponse.data._id).then((response)=>{
